...
def plot():    #Function to create the base plot, make sure to make global the lines, axes, canvas and any part that you would want to update later
    ...
    #configurables:
    global baseLine #baseline of y axis
    baseLine = 0
    global maxLine #highest y axis point
    maxLine = 23
    global pvThreshold #determines when to show prevoice lines. Increasing the multiplier means you must be closer to the highest point on the y axis
    pvThreshold = maxLine * .8
    global peakWidth #how far from the prevoice line detection point to place the first line. Higher # = further away
    peakWidth = .7
    global peakWidthPv #how far from the prevoice line detection point to place the second line. Higher # = further away
...
def prevoice(ys):
    ...
    global pvThreshold
    global peakWidth
    if(ys[-1] > ys[-3] and pvWait > 5 and ys[-1] > pvThreshold):
        print("found it")
